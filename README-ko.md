...
- [mwl313/KatokMCP](https://github.com/mwl313/KatokMCP) 📇 🏠 🍎 🪟 🐧 - 카카오톡 MCP 서버. AI 비서(Claude/OpenClaw)가 채팅방 목록 확인, 메시지 읽기/전송, 멤버 조회 가능. 1회 폰 인증, Token Caching 지원. 설치: `npm install -g @katok-mcp/mcp-server && katok-mcp setup`
